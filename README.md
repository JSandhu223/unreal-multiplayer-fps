...
- `CombatComponent` defines multiple delegates for communicating info about the current weapon to the overlay.
  ...
  - `FOnCurrentReserveAmmoChanged` broadcasts the reserve ammo, current ammo of the equipped weapon whenever `CurrentReserveAmmo` replicates (via RepNotify), and the weapon icon.
